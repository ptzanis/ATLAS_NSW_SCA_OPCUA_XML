...
if(args['mode']=="U"):
   fileXML=open('sector_'+sector+'_Uncalibration_STG_'+location+'.xml',"w+")

if(args['mode']=="S"):
   fileXML=open('sector_'+sector+'_Simulation_STG_'+location+'.xml',"w+")
...
for board,elink in zip(boards,elinks):
    ...
    if(args['L1DDC']==True):
	  if(re.compile("L1DDC").match(board)):
	    ...
	    if(args['mode']=="U"):
	      fileXML.write(templateL1DDC_RIML1DDC1_RIML1DDC2_Uncalibrated() % (opcHost,felixDeviceId,felixDeviceId,elink,board,"L1DDC_STG"))
	    if(args['mode']=="S"):
	      fileXML.write(templateL1DDC_RIML1DDC1_RIML1DDC2_Simulation() % (counter,board,"L1DDC_STG"))	
